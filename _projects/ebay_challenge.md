...
> _Due to the competition’s data usage agreement and model disclosure restrictions, we are unable to share implementation details, dataset-specific processing steps, or proprietary configurations. The description below intentionally remains high-level while reflecting the overall structure of our work._
