...
<div class="publications">
  <ol>
    ...
    <li>
      <div><em>Using Item-Response Theory to Disentangle Local vs. Global Processing Dispositions in Autistic Cognition: Comparing Multi-Modal Comics vs. Text-Based Narratives in a Randomized Study</em></div>
      ...
      <div><strong>Venue:</strong> Discourse Processes Journal</div>
    </li>
    <li>
      <div><em>Shaping Human-AI Collaboration: AI Draft Quality Thresholds for Audio Description</em></div>
      <div><strong>Authors:</strong> Lana Do, Shasta Ihorn, Charity M Pitcher-Cooper, Sanjay Mirani, <strong>Gio Jung</strong>, Hyunjoo Shim, Zhenzhen Qin, Kien T. Nguyen Mr, Vassilis Athitsos, Ilmi Yoon</div>
