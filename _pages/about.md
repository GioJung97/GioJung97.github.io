...
또한 자폐 학습자의 독해를 돕기 위해 이야기를 구조화된 만화로 변환하는 저작 도구를 만드는 **Mosaic Cognition**의 공동 창업자이자 리드 엔지니어(Lead Engineer)이기도 합니다. 시스템 아키텍처부터 데이터 및 추론 파이프라인, 풀스택 개발까지 제품의 엔지니어링 전반을 이끌고 있습니다.
